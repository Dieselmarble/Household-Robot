...
void passFilter2(pcl::PointCloud<pcl::PointXYZ>::Ptr input, pcl::PointCloud<pcl::PointXYZ>::Ptr output);
void statisticalFilter(pcl::PointCloud<pcl::PointXYZ>::Ptr input, pcl::PointCloud<pcl::PointXYZ>::Ptr output);
void radiusFilter(pcl::PointCloud<pcl::PointXYZ>::Ptr input, pcl::PointCloud<pcl::PointXYZ>::Ptr output);
...
void cloud_cb (const sensor_msgs::PointCloud2ConstPtr& input)
{
  ...
  pcl::PointCloud<pcl::PointXYZ>::Ptr cloudFiltered4 (new pcl::PointCloud<pcl::PointXYZ> ());
  pcl::PointCloud<pcl::PointXYZ>::Ptr cloudFiltered5 (new pcl::PointCloud<pcl::PointXYZ> ());
...
void passFilter(pcl::PointCloud<pcl::PointXYZ>::Ptr input, pcl::PointCloud<pcl::PointXYZ>::Ptr output)
{
  ...
  passFilter.setFilterLimits(-4.0, 4.0);//(4,4)
...
void passFilter2(pcl::PointCloud<pcl::PointXYZ>::Ptr input, pcl::PointCloud<pcl::PointXYZ>::Ptr output)
{
  ...
  passFilter.setInputCloud(input);
  passFilter.setFilterFieldName("z");
  passFilter.setFilterLimits(-0.4, 0.4);//(-0.9,0.4)
  // pass.setFilterLimitNegative(true) // false: keep, true: reject
  passFilter.filter(*output);
}
...
void radiusFilter(pcl::PointCloud<pcl::PointXYZ>::Ptr input, pcl::PointCloud<pcl::PointXYZ>::Ptr output)
{
  ...
  radiusFilter.setMinNeighborsInRadius(5);//10
...
int main (int argc, char** argv)
{
  ...
  // if(octoClearClient.waitForExistence(ros::Duration(3.0))) {
